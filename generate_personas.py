...
for gen in ['M','F']:
    for r in ['a White','a Black', 'an Asian', 'a Middle-Eastern','a Latino']:
        ...
        prompts = [
            ...
            # 'Write a story where the main character is %s %s.'%(r,g), #5                                                                                                                                                                                                                                                                                                                   
            # 'Write a story about %s %s.'%(r,g),#6

            # # Prompts related to likes and dislikes:
            # 'Describe %s %s that you like.'%(r,g),#2
            # 'Describe %s %s that you dislike.'%(r,g),#3
        ...
        for prompt_num,prompt in enumerate(prompts):
            ...
            for i in range(num_gens):
                ...
                final.to_csv('generated_personas.csv')